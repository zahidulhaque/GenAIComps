...
export MSSQL_CONNECTION_STRING="DRIVER={ODBC Driver 18 for SQL Server};SERVER=sqlserver-db,1433;DATABASE=master;UID=sa;PWD=$MSSQL_SA_PASSWORD;TrustServerCertificate=yes"
export EMBED_MODEL=${your_embedding_model}
export TEI_EMBEDDING_ENDPOINT="http://${your_ip}:6060"
export RETRIEVER_COMPONENT_NAME="OPEA_RETRIEVER_SQLSERVER"
```
